...
`})))()}var Wt;function Gt(){return(Gt=t((()=>{Wt=`/**
 * Patterns/Alert — unified master (.c-alert).
...
`})))()}var Jt;function Yt(){return(Yt=t((()=>{Jt=`/**
...
`})))()}var Xt;function Zt(){return(Zt=t((()=>{Xt=`/**
...
`})))()}var Qt;function $t(){return($t=t((()=>{Qt=`/**
 * Patterns/Breadcrumb — .c-breadcrumb
...
`})))()}var en;function tn(){return(tn=t((()=>{en=`/**
...
`})))()}var nn;function rn(){return(rn=t((()=>{nn=`/**
 * Patterns/Card — BEM root (.c-card).
...
`})))()}var an;function on(){return(on=t((()=>{an=`/**
...
`})))()}var sn;function cn(){return(cn=t((()=>{sn=`// Patterns/Inputs/Code entry
...
`})))()}var ln;function un(){return(un=t((()=>{ln=`/**
...
`})))()}var bn;function xn(){return(xn=t((()=>{bn=`/**
...
`})))()}var Sn;function Cn(){return(Cn=t((()=>{Sn=`/**
...
`})))()}var wn;function Tn(){return(Tn=t((()=>{wn=`/**
...
`})))()}var En;function Dn(){return(Dn=t((()=>{En=`/**
 * Blocks/Lower footer — BEM root .c-lower-footer
...
`})))()}var On;function kn(){return(kn=t((()=>{On=`/**
...
`})))()}var An;function jn(){return(jn=t((()=>{An=`/**
...
`})))()}var Mn;function Nn(){return(Nn=t((()=>{Mn=`/**
...
`})))()}var Pn;function Fn(){return(Fn=t((()=>{Pn=`/**
...
`})))()}var In;function Ln(){return(Ln=t((()=>{In=`/**
...
`})))()}var Rn;function zn(){return(zn=t((()=>{Rn=`/**
...
`})))()}var Bn;function Vn(){return(Vn=t((()=>{Bn=`/**
...
`})))()}var Hn;function Un(){return(Un=t((()=>{Hn=`/**
...
`})))()}var Wn;function Gn(){return(Gn=t((()=>{Wn=`/**
...
`})))()}var Kn;function qn(){return(qn=t((()=>{Kn=`/**
...
`})))()}var Jn;function Yn(){return(Yn=t((()=>{Jn=`// Patterns/Inputs/Search box
...
`})))()}var Xn;function Zn(){return(Zn=t((()=>{Xn=`/**
...
`})))()}var Qn;function $n(){return($n=t((()=>{Qn=`/**
...
`})))()}var er;function tr(){return(tr=t((()=>{er=`/**
...
`})))()}var nr;function rr(){return(rr=t((()=>{nr=`/**
...
`})))()}var ir;function ar(){return(ar=t((()=>{ir=`/**
 * Patterns/Table block — BEM root (.c-table-block).
...
`})))()}var or;function sr(){return(sr=t((()=>{or=`/**
 * Molecules/Table cell — BEM root (.c-table-cell).
...
`})))()}var cr;function lr(){return(lr=t((()=>{cr=`/**
 * Patterns/Tabs — BEM root (.c-tabs).
...
`})))()}var ur;function dr(){return(dr=t((()=>{ur=`/**
...
`})))()}var fr;function pr(){return(pr=t((()=>{fr=`// Patterns/Inputs/Text field
...
`})))()}var mr;function hr(){return(hr=t((()=>{mr=`/**
...
`})))()}var gr;function _r(){return(_r=t((()=>{gr=`/**
 * Patterns/Toggle — BEM root (.c-toggle).
 * Figma: Pattern / Toggle 539:28414 / Spec 4588:132.
 *
...
`})))()}var vr;function yr(){return(yr=t((()=>{vr=`/**
 * Molecules/Tooltip — BEM root (.c-tooltip).
 * Figma: Pattern / Tooltip 539:28418 / Spec 4601:164.
 *
...
`})))()}var br;function xr(){return(xr=t((()=>{br=`/**
 * Patterns/Trustpilot — review cell (.c-trustpilot).
...
`})))()}var wr;function Tr(){return(Tr=t((()=>{wr=`/**
...
`})))()}var Er;function Dr(){return(Dr=t((()=>{Er=`/**
...
`})))()}var Or;function kr(){return(kr=t((()=>{Or=`/**
...
`})))()}var Ar;function jr(){return(jr=t((()=>{Ar=`/**
...
`})))()}var Mr;function Nr(){return(Nr=t((()=>{Mr=`/**
...
`})))()}var Pr;function Fr(){return(Fr=t((()=>{Pr=`export const RATIO_OPTIONS = ['16-9', '4-3', '1-1', '3-4', '2-1'];
export const ALIGNMENT_OPTIONS = ['top-left', 'top-right', 'bottom-left', 'bottom-right'];

export const defaultCardArgs = {
  ratio: '16-9',
  alignment: 'bottom-left',
  imageSrc: '/assets/images/sample.jpg',
  imageAlt: '',
  label: 'label',
  showLabel: true,
...
export function normalizeCardArgs(args = {}) {
  ...
  return {
    ...
    imageSrc: args.imageSrc || '/assets/images/sample.jpg',
...
`})))()}var Ir;function Lr(){return(Lr=t((()=>{Ir=`/**
...
`})))()}var Rr;function zr(){return(zr=t((()=>{Rr=`/**
...
`})))()}var Br;function Vr(){return(Vr=t((()=>{Br=`/**
...
`})))()}var Hr;function Ur(){return(Ur=t((()=>{Hr=`export const THEME_OPTIONS = ['light', 'dark'];
...
export const defaultLowerFooterArgs = {
  theme: 'light',
  showLowerLinks: true,
  logoSrc: '/assets/logos/gen-horizontal.svg',
  logoAlt: 'Gen',
  brandName: '[Brand]',
  statement: '',
...
export function normalizeLowerFooterArgs(args = {}) {
  ...
  return {
    ...
    logoSrc: args.logoSrc || '/assets/logos/gen-horizontal.svg',
...
`})))()}var Wr;function Gr(){return(Gr=t((()=>{Wr=`/**
...
`})))()}var Kr;function qr(){return(qr=t((()=>{Kr=`/**
...
`})))()}var Jr;function Yr(){return(Yr=t((()=>{Jr=`/**
...
`})))()}var Xr;function Zr(){return(Zr=t((()=>{Xr=`/**
...
`})))()}var Qr;function $r(){return($r=t((()=>{Qr=`/**
...
`})))()}var ei;function ti(){return(ti=t((()=>{ei=`/**
...
`})))()}var ni;function ri(){return(ri=t((()=>{ni=`/**
...
`})))()}var ii;function ai(){return(ai=t((()=>{ii=`/**
...
`})))()}var oi;function si(){return(si=t((()=>{oi=`/**
...
`})))()}var ci;function li(){return(li=t((()=>{ci=`/**
...
`})))()}var ui;function di(){return(di=t((()=>{ui=`/**
...
`})))()}var fi;function pi(){return(pi=t((()=>{fi=`/**
...
`})))()}var mi;function hi(){return(hi=t((()=>{mi=`/**
...
`})))()}var gi;function _i(){return(_i=t((()=>{gi=`/**
...
`})))()}var vi;function yi(){return(yi=t((()=>{vi=`export const STYLE_OPTIONS = ['solid', 'subtle'];
...
`})))()}var bi;function xi(){return(xi=t((()=>{bi=`/**
...
`})))()}var Si;function Ci(){return(Ci=t((()=>{Si=`export const BACKGROUND_OPTIONS = [
  'primary',
  'secondary',
  'brand',
  'brand-soft',
...
`})))()}var wi;function Ti(){return(Ti=t((()=>{wi=`/**
...
`})))()}var Ei;function Di(){return(Di=t((()=>{Ei=`export const TYPE_OPTIONS = ['link', 'segmented', 'pill'];
...
`})))()}var Oi;function ki(){return(ki=t((()=>{Oi=`/**
...
`})))()}var Ai;function ji(){return(ji=t((()=>{Ai=`export const TYPE_OPTIONS = ['small', 'medium', 'rich'];
...
`})))()}var Mi;function Ni(){return(Ni=t((()=>{Mi=`/**
...
`})))()}var Pi;function Fi(){return(Fi=t((()=>{Pi=`import {
  buildStarLadder,
  formatScore,
  trustpilotTierColor,
...
`})))()}function Ii(e){if(!e)return{scss:null,js:null};let t=(t,n)=>[`/src/components/${e}/${e}.${n}`,`/src/layouts/${e}/${e}.${n}`,`/src/pages/${e}/${e}.${n}`].reduce((e,n)=>e??t[n]??null,null);return{scss:t(Bi,`scss`)??t(Hi,`scss`)??t(Wi,`scss`),js:t(Vi,`js`)??t(Ui,`js`)??t(Gi,`js`)}}function Li(e,t={}){let{unit:n,scss:r,js:i,extra:a={}}=t,o=Ii(n),s=r??o.scss,c=i??o.js,l=s&&String(s).trim()||c&&String(c).trim()?zi(e,{js:c,scss:s}):String(e).trim(),{docs:u,...d}=a;return{...d,docs:{...u&&typeof u==`object`?u:{},source:{code:l,language:`html`,type:`code`}}}}function Ri(e,t){let n=RegExp(`</${t}`,`gi`);return String(e).replace(n,`<\\/${t}`)}function zi(e,{js:t,scss:n}={}){let r=[String(e).trim()];if(t&&String(t).trim()){let e=Ri(String(t).trim(),`script`);r.push(``,`<!-- ── JavaScript ── -->`,`<script>`,e,`<\/script>`)}if(n&&String(n).trim()){let e=Ri(String(n).trim(),`style`);r.push(``,`<!-- ── SCSS ── -->`,`<style>`,e,`</style>`)}return r.join(`
`)}var Bi,Vi,Hi,Ui,Wi,Gi;function Ki(){return(Ki=t((()=>{Ut(),Gt(),qt(),Yt(),Zt(),$t(),tn(),rn(),on(),cn(),un(),$(),pn(),hn(),_n(),yn(),xn(),Cn(),Tn(),Dn(),kn(),jn(),Nn(),Fn(),Ln(),zn(),Vn(),Un(),Gn(),qn(),Yn(),Zn(),$n(),tr(),rr(),ar(),sr(),lr(),dr(),pr(),hr(),_r(),yr(),xr(),Cr(),Tr(),Dr(),kr(),jr(),Nr(),Fr(),Lr(),zr(),Vr(),Ur(),Gr(),qr(),Yr(),Zr(),$r(),ti(),ri(),ai(),si(),li(),di(),pi(),hi(),_i(),yi(),xi(),Ci(),Ti(),Di(),ki(),ji(),Ni(),Fi(),Bi=Object.assign({"/src/components/accordion/accordion.scss":Ht,"/src/components/alert/alert.scss":Wt,"/src/components/award-item/award-item.scss":Kt,"/src/components/award-wrapper/award-wrapper.scss":Jt,"/src/components/badge/badge.scss":Xt,"/src/components/breadcrumb/breadcrumb.scss":Qt,"/src/components/button/button.scss":en,"/src/components/card/card.scss":nn,"/src/components/checkbox/checkbox.scss":an,"/src/components/code-entry/code-entry.scss":sn,"/src/components/content-block/content-block.scss":ln,"/src/components/content-body/content-body.scss":dn,"/src/components/content-list/content-list.scss":fn,"/src/components/content-title/content-title.scss":mn,"/src/components/discount-label/discount-label.scss":gn,"/src/components/divider/divider.scss":vn,"/src/components/icon/icon.scss":bn,"/src/components/image-wrapper/image-wrapper.scss":Sn,"/src/components/logo-wrapper/logo-wrapper.scss":wn,"/src/components/lower-footer/lower-footer.scss":En,"/src/components/media/media.scss":On,"/src/components/menu-block/menu-block.scss":An,"/src/components/menu-list/menu-list.scss":Mn,"/src/components/modal/modal.scss":Pn,"/src/components/pagination/pagination.scss":In,"/src/components/pagination-dots/pagination-dots.scss":Rn,"/src/components/pricing/pricing.scss":Bn,"/src/components/progress-indicator/progress-indicator.scss":Hn,"/src/components/radio/radio.scss":Wn,"/src/components/rating/rating.scss":Kn,"/src/components/search-box/search-box.scss":Jn,"/src/components/sheet/sheet.scss":Xn,"/src/components/slider/slider.scss":Qn,"/src/components/stepper/stepper.scss":er,"/src/components/switch/switch.scss":nr,"/src/components/table-block/table-block.scss":ir,"/src/components/table-cell/table-cell.scss":or,"/src/components/tabs/tabs.scss":cr,"/src/components/tag/tag.scss":ur,"/src/components/text-field/text-field.scss":fr,"/src/components/text-link/text-link.scss":mr,"/src/components/toggle/toggle.scss":gr,"/src/components/tooltip/tooltip.scss":vr,"/src/components/trustpilot/trustpilot.scss":br}),Vi=Object.assign({"/src/components/accordion/accordion-helpers.js":Sr,"/src/components/accordion/accordion.js":wr,"/src/components/alert/alert-helpers.js":Er,"/src/components/alert/alert.js":Or,"/src/components/breadcrumb/breadcrumb-story-helpers.js":Ar,"/src/components/button/button-helpers.js":Mr,"/src/components/card/card-story-helpers.js":Pr,"/src/components/checkbox/checkbox.js":Ir,"/src/components/code-entry/code-entry.js":Rr,"/src/components/content-list/content-list-helpers.js":Br,"/src/components/lower-footer/lower-footer-story-helpers.js":Hr,"/src/components/media/media-helpers.js":Wr,"/src/components/menu-block/menu-block.js":Kr,"/src/components/modal/modal.js":Jr,"/src/components/pagination/pagination-helpers.js":Xr,"/src/components/pagination/pagination.js":Qr,"/src/components/radio/radio.js":ei,"/src/components/rating/rating-helpers.js":ni,"/src/components/search-box/search-box.js":ii,"/src/components/sheet/sheet.js":oi,"/src/components/slider/slider.js":ci,"/src/components/stepper/stepper-story-helpers.js":ui,"/src/components/switch/switch.js":fi,"/src/components/table-block/table-block-story-helpers.js":mi,"/src/components/table-cell/table-cell-story-helpers.js":gi,"/src/components/tabs/tabs-story-helpers.js":vi,"/src/components/tabs/tabs.js":bi,"/src/components/tag/tag-story-helpers.js":Si,"/src/components/text-field/text-field.js":wi,"/src/components/toggle/toggle-story-helpers.js":Ei,"/src/components/toggle/toggle.js":Oi,"/src/components/tooltip/tooltip-story-helpers.js":Ai,"/src/components/tooltip/tooltip.js":Mi,"/src/components/trustpilot/trustpilot-story-helpers.js":Pi}),Hi=Object.assign({}),Ui=Object.assign({}),Wi=Object.assign({}),Gi=Object.assign({})})))()}export{Bt as $,Le as $t,yn as A,P as An,ct as At,un as B,$e as Bt,Tn as C,z as Cn,gt as Ct,bn as D,F as Dn,ut as Dt,Cn as E,L as En,pt as Et,fn as F,rt as Ft,Kt as G,Ke as Gt,tn as H,Xe as Ht,pn as I,nt as It,Gt as J,Ge as Jt,qt as K,qe as Kt,dn as L,tt as Lt,_n as M,M as Mn,ot as Mt,mn as N,D as Nn,at as Nt,xn as O,I as On,ft as Ot,hn as P,O as Pn,it as Pt,Vt as Q,Ve as Qt,$ as R,et as Rt,On as S,V as Sn,_t as St,Sn as T,R as Tn,mt as Tt,Qt as U,Ye as Ut,en as V,Ze as Vt,$t as W,Je as Wt,Ut as X,Ue as Xt,Ht as Y,He as Yt,Q as Z,Be as Zt,Nn as _,K as _n,St as _t,hr as a,je as an,Pt as at,An as b,U as bn,yt as bt,Xn as c,Ae as cn,jt as ct,Vn as d,Te as dn,Ot as dt,Re as en,zt as et,Bn as f,Z as fn,Dt as ft,Pn as g,J as gn,Ct as gt,Fn as h,q as hn,wt as ht,Tr as i,Ne as in,It as it,gn as j,j as jn,st as jt,vn as k,N as kn,lt as kt,qn as l,Ee as ln,At as lt,In as m,Y as mn,Tt as mt,Ki as n,Ie as nn,Rt as nt,mr as o,Me as on,Nt as ot,Ln as p,X as pn,Et as pt,Wt as q,We as qt,wr as r,Pe as rn,Ft as rt,Zn as s,ke as sn,Mt as st,Li as t,Fe as tn,Lt as tt,Kn as u,De as un,kt as ut,Mn as v,G as vn,xt as vt,wn as w,B as wn,ht as wt,kn as x,H as xn,vt as xt,jn as y,W as yn,bt as yt,ln as z,Qe as zt};