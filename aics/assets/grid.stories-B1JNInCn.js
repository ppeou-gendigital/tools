...
`})))()}var f,p,m;function h(){return(h=e((()=>{d(),f={title:`Design System/Grid`,parameters:{docs:{description:{component:"Contract-driven grid & breakpoints gallery (Figma Web-ODS-Theme 18086:2008). SM/MD/LG/XL from `themes/contract.yaml`; values from `themes/default/_grid.scss`."}}}},p={name:`Grid`,render:()=>c({brandLabel:`White Label`})},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  name: 'Grid',
