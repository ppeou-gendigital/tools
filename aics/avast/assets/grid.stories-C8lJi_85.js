...
`})))()}var f,p,m;function h(){return(h=e((()=>{d(),f={title:`Design System/Grid`,parameters:{docs:{description:{component:"Avast grid & breakpoints gallery. Shared renderer from `@aics/storybook-core`; values from `themes/default/_grid.scss`."}}}},p={name:`Grid`,render:()=>c({brandLabel:`Avast`})},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  name: 'Grid',
