...
`})))()}var u,d,f;function p(){return(p=e((()=>{l(),u={title:`Design System/Opacity`,parameters:{docs:{description:{component:"Avast opacity gallery. Shared renderer from `@aics/storybook-core`; values from `themes/default/_opacity.scss`."}}}},d={name:`Opacity`,render:()=>s({brandLabel:`Avast`})},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  name: 'Opacity',
