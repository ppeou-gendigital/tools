...
Canonical absolute base for this library: `http://localhost:4173/avast/`
...
After fetching `http://localhost:4173/avast/api/components/accordion.json`, the manifest lists paths like
`/api/components/accordion/source/accordion.scss`. Absolute fetches:

- http://localhost:4173/avast/api/components/accordion/spec.md
- http://localhost:4173/avast/api/components/accordion/source/accordion.hbs
- http://localhost:4173/avast/api/components/accordion/source/accordion.scss
- http://localhost:4173/avast/api/components/accordion/source/accordion.js
