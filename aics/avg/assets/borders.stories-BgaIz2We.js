...
`,d=[`0`,`xs`,`s`,`m`,`l`,`xl`,`xxl`,`xxxl`]})))()}var p,m,h;function g(){return(g=e((()=>{f(),p={title:`Design System/Borders`,parameters:{docs:{description:{component:"AVG borders gallery. Shared renderer from `@aics/storybook-core`; values from `themes/default/_borders.scss`."}}}},m={name:`Borders`,render:()=>l({brandLabel:`AVG`})},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  name: 'Borders',
