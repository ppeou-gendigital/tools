...
Canonical absolute base for this library: `https://ppeou-gendigital.github.io/tools/aics/lifelock/`
...
After fetching `https://ppeou-gendigital.github.io/tools/aics/lifelock/api/components/accordion.json`, the manifest lists paths like
`/api/components/accordion/source/accordion.scss`. Absolute fetches:

- https://ppeou-gendigital.github.io/tools/aics/lifelock/api/components/accordion/spec.md
- https://ppeou-gendigital.github.io/tools/aics/lifelock/api/components/accordion/source/accordion.hbs
- https://ppeou-gendigital.github.io/tools/aics/lifelock/api/components/accordion/source/accordion.scss
- https://ppeou-gendigital.github.io/tools/aics/lifelock/api/components/accordion/source/accordion.js
