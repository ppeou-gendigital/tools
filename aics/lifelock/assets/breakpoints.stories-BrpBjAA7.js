...
`,x={sm:{min:0,max:767},md:{min:768,max:1023},lg:{min:1024,max:1439},xl:{min:1440,max:1/0}},S={title:`Design System/Breakpoints`,parameters:{contentWidth:`fluid`,design:u(y.frontmatter.figmaNodeId||`0:31`),docs:{description:{component:"Breakpoint thresholds (4 mutually-exclusive bands) sourced from `storybook-lifelock/src/tokens/breakpoints/spec.md`. The `## Token values` table renders with the active band highlighted in brand colour based on the live Storybook viewport width."}}}},C={name:`Breakpoints`,render:()=>l({storySpec:y,tableHook:v})},C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  name: 'Breakpoints',
