...
`,v={title:`Design System/Spacing`,parameters:{contentWidth:`fluid`,design:n(g.frontmatter.figmaNodeId||`18014:755`),docs:{description:{component:"Spacing primitive ladder sourced from `storybook-lifelock/src/tokens/spacing/spec.md`. The `## Token values` table renders as a bar gallery scaled to each token's live px value; reserved indices and design decisions render from the spec verbatim."}}}},y={name:`Spacing`,render:()=>u({storySpec:g,tableHook:h})},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  name: 'Spacing',
