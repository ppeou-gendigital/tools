import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{i as t,it as n,n as r,r as i,rt as a,t as o}from"./pretty-source-CS7MQ53Z.js";import"./content-title-BvltFXQ5.js";var s;function c(){return(c=e((()=>{s=`/**
...
`})))()}function l(e){return g.has(e)?e:`h2`}function u(e){return d({style:e.style||`h0`,weight:e.weight||`emphasis`,text:e.text??`Heading`,tag:l(e.tag||`h2`),className:e.className||``})}var d,f,p,m,h,g,_,v,y,b;function x(){return(x=e((()=>{t(),r(),c(),n(),d=i.default.compile(a),f=[`h0`,`h1`,`h2`,`h3`,`h4`,`h5`,`h6`,`h7`],p=[`subtle`,`base`,`prominent`,`emphasis`,`strong`],m=[`h1`,`h2`,`h3`,`h4`,`h5`,`h6`,`p`],h=`https://www.figma.com/design/0o8SL5BEk8wHtgud00dRyg/Web-ODS-Shared-Library?node-id=3598-7174&m=dev`,g=new Set(m),_={title:`Molecules/Content title`,tags:[`autodocs`],parameters:{docs:{description:{component:`Heading typography molecule (Style × Weight = 8 × 5). Inherited from core. Default Weight=emphasis. [Figma](${h}).`}}},argTypes:{style:{control:{type:`inline-radio`},options:f,name:`Style`},weight:{control:{type:`inline-radio`},options:p,name:`Weight`},tag:{control:{type:`inline-radio`},options:m,name:`tag (semantic)`},text:{control:`text`,name:`Text`},className:{control:`text`,name:`className`}},args:{style:`h0`,weight:`emphasis`,tag:`h2`,text:`Heading`,className:``}},v={name:`Demo`,render:e=>u(e),parameters:o(u({style:`h0`,weight:`emphasis`,tag:`h2`,text:`Heading`,className:``}),{scss:s})},y={name:`AllStyles`,render:()=>`
