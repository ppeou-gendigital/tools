import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{c as t,i as n,n as r,r as i,s as a,t as o}from"./pretty-source-BkPpK8QA.js";import"./divider-CMa0ijyT.js";var s;function c(){return(c=e((()=>{s=`/**
...
`)}</div>
      ...
      </div>`},x={name:`Horizontal`,args:{layout:`horizontal`,size:`s`,inverse:!1},render:e=>l(e),parameters:o(l({..._,layout:`horizontal`}),{scss:s})},S={name:`Vertical`,args:{layout:`vertical`,size:`s`,inverse:!1},render:e=>`
    <div style="display:flex;align-items:stretch;block-size:80px;gap:var(--space-4,16px);">
      <div>Left column content</div>
      ${l(e)}
      <div>Right column content</div>
    </div>`},C={name:`Label`,args:{layout:`label`,size:`s`,inverse:!1,typography:`body-sm-regular`,label:`Or`},render:e=>l(e),parameters:o(l({..._,layout:`label`}),{scss:s})},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  name: 'Demo',
  render: args => {
