...
`})))()}var d,f,p;function m(){return(m=e((()=>{u(),d={title:`Design System/Spacing`,parameters:{docs:{description:{component:"AVG spacing gallery. Shared renderer from `@aics/storybook-core`; values from `themes/default/_spacing.scss`."}}}},f={name:`Spacing`,render:()=>c({brandLabel:`AVG`})},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  name: 'Spacing',
