...
`})))()}var h,g,_;function v(){return(v=e((()=>{m(),h={title:`Design System/Typography`,parameters:{docs:{description:{component:"AVG typography gallery. Shared renderer from `@aics/storybook-core`; values from `themes/default/_tokens.scss` (Roboto primary)."}}}},g={name:`Typography`,render:()=>u({brandLabel:`AVG`})},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  name: 'Typography',
