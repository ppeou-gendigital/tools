...
// ============================================================================
// Mirrors the Figma square control at 20×20 outer with \`--space-1\` pad
// (border-box) → inner glyph 16×16. Icon \`size="16"\`; do not also pass
// \`size="20"\` (control-pad + icon-size double-count).
