...
`)}</div>
      ...
      </div>`},x={name:`Horizontal`,args:{layout:`horizontal`,size:`s`,inverse:!1},render:e=>l(e),parameters:c(l({..._,layout:`horizontal`}),{unit:`divider`,scss:a})},S={name:`Vertical`,args:{layout:`vertical`,size:`s`,inverse:!1},render:e=>`
    <div style="display:flex;align-items:stretch;block-size:80px;gap:var(--space-4,16px);">
      <div>Left column content</div>
      ${l(e)}
      <div>Right column content</div>
    </div>`},C={name:`Label`,args:{layout:`label`,size:`s`,inverse:!1,typography:`body-sm-regular`,label:`Or`},render:e=>l(e),parameters:c(l({..._,layout:`label`}),{unit:`divider`,scss:a})},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  name: 'Demo',
  render: args => {
