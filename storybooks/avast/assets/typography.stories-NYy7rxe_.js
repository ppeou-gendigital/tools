...
`})))()}var h,g,_;function v(){return(v=e((()=>{m(),h={title:`Design System/Typography`,parameters:{docs:{description:{component:"Avast typography gallery. Shared renderer from `@aics/storybook-core`; values from `themes/default/_tokens.scss` (Mier B03 Pan primary)."}}}},g={name:`Typography`,render:()=>u({brandLabel:`Avast`})},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  name: 'Typography',
