...
`})))()}var u,d,f;function p(){return(p=e((()=>{l(),u={title:`Design System/Opacity`,parameters:{docs:{description:{component:"Norton opacity gallery. Shared renderer from `@aics/storybook-core`; values from `themes/default/_opacity.scss`."}}}},d={name:`Opacity`,render:()=>s({brandLabel:`Norton`})},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  name: 'Opacity',
