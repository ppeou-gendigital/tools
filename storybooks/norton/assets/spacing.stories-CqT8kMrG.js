...
`})))()}var d,f,p;function m(){return(m=e((()=>{u(),d={title:`Design System/Spacing`,parameters:{docs:{description:{component:"Norton spacing gallery. Shared renderer from `@aics/storybook-core`; values from `themes/default/_spacing.scss`."}}}},f={name:`Spacing`,render:()=>c({brandLabel:`Norton`})},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  name: 'Spacing',
