...
Canonical absolute base for this library: `http://localhost:4173/norton/`
...
2. Fetch [`llms.txt`](./llms.txt)
   Absolute: `http://localhost:4173/norton/llms.txt`
3. Fetch [`/api/index.json`](./api/index.json), find the unit, then fetch
   `/api/<type>/<name>.json`
   (example: `http://localhost:4173/norton/api/components/accordion.json`).
...
After fetching `http://localhost:4173/norton/api/components/accordion.json`, the manifest lists paths like
`/api/components/accordion/source/accordion.scss`. Absolute fetches:

- http://localhost:4173/norton/api/components/accordion/spec.md
- http://localhost:4173/norton/api/components/accordion/source/accordion.hbs
- http://localhost:4173/norton/api/components/accordion/source/accordion.scss
- http://localhost:4173/norton/api/components/accordion/source/accordion.js
...
- Storybook UI: http://localhost:4173/norton/
