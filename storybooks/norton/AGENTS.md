# Agent instructions — Norton Design System

Package: `@aics/storybook-norton`. Self-contained library — consume this brand alone.
...
Canonical absolute base for this library: `https://ppeou-gendigital.github.io/tools/aics/norton/`
...
2. Fetch [`llms.txt`](./llms.txt)
   Absolute: `https://ppeou-gendigital.github.io/tools/aics/norton/llms.txt`
3. Fetch [`/api/index.json`](./api/index.json), find the unit, then fetch
   `/api/<type>/<name>.json`
   (example: `https://ppeou-gendigital.github.io/tools/aics/norton/api/components/accordion.json`).
...
After fetching `https://ppeou-gendigital.github.io/tools/aics/norton/api/components/accordion.json`, the manifest lists paths like
`/api/components/accordion/source/accordion.scss`. Absolute fetches:

- https://ppeou-gendigital.github.io/tools/aics/norton/api/components/accordion/spec.md
- https://ppeou-gendigital.github.io/tools/aics/norton/api/components/accordion/source/accordion.hbs
- https://ppeou-gendigital.github.io/tools/aics/norton/api/components/accordion/source/accordion.scss
- https://ppeou-gendigital.github.io/tools/aics/norton/api/components/accordion/source/accordion.js
...
- Storybook UI: https://ppeou-gendigital.github.io/tools/aics/norton/
